												...
												<div class="col-md-2" style="margin-bottom:10px;">
													<div class="card cta cta--featured">
													  ...
													  <div class="card-block">
														...
														<a href="{{ route('delImg',$photo->path) }}" onclick="return areyousure();" class="btn btn-xs btn-danger"><i class="fa fa-fw fa-remove"></i> Hapus</a>
													  </div>
													</div>
												</div>
												@endif
							...
							<div class="col-xs-12">
								<div class="box box-primary box-solid">
									...
									<div class="box-body">
										...
										<form id="formPhotoDropzone" class="dropzone" method="POST" action="/admin/proposals/upload" enctype="multipart/form-data">
									...
									<div class="card cta cta--featured">
										...
										<div class="card-block">
			                                @if(file_exists( public_path('upload/media/proposal/'.$Proposal->file) ))
												...
												<a href="{{ route('delFile',$Proposal->id) }}" onclick="return areyousure();" class="btn btn-xs btn-danger"><i class="fa fa-fw fa-remove"></i> Hapus</a>
			                                @endif
										</div>
									</div>
							</div>
							...
							<div class="col-xs-12">
								<div class="box box-primary box-solid">
									...
									<div class="box-body documents-container">
										...
										<form id="formDocumentDropzone" class="dropzone" method="POST" action="/admin/proposals/uploadFile" enctype="multipart/form-data">
											<input type="hidden" name="_token" value="{{ csrf_token() }}">
											<input type="hidden" name="proposal_id" value="{{ $Proposal->id }}">
							...
							<div class="col-md-2" style="margin-bottom:10px;">
								<div class="card cta cta--featured">
								  ...
								  <div class="card-block">
									...
									<a href="{{ route('delFileLPJ',$lpjfile->path) }}" onclick="return areyousure();" class="btn btn-xs btn-danger"><i class="fa fa-fw fa-remove"></i> Hapus</a>
								  </div>
								</div>
							</div>
							@endif
							...
							<div class="col-xs-12">
								<div class="box box-primary box-solid">
									...
									<div class="box-body documents-container">
										...
										<form id="formDocumentLPJDropzone" class="dropzone" method="POST" action="/admin/proposals/uploadFileLPJ" enctype="multipart/form-data">
											<input type="hidden" name="_token" value="{{ csrf_token() }}">
											<input type="hidden" name="proposal_id" value="{{ $Proposal->id }}">
